                            ...
                            >
                                ...
                                <div className="flex items-center gap-5">
                                    <div className={cn(
                                        ...
                                        profile.role === 'admin'
                                            ? "bg-slate-900 text-white shadow-slate-900/20 dark:bg-white dark:text-slate-900"
                                            : "bg-slate-100 text-slate-500 shadow-slate-200/50 dark:bg-slate-800 dark:text-slate-400"
                                    )}>
